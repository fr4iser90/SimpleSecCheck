...
class KubeHunterScanner(BaseScanner):
    ...
    ENV_VARS = {
        "KUBE_HUNTER_CONFIG_PATH": "/app/scanner/plugins/kube_hunter/config/config.yaml"
    }
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("KUBE_HUNTER_CONFIG_PATH", "/app/scanner/plugins/kube_hunter/config/config.yaml")
