...
class BanditScanner(BaseScanner):
    ...
    ENV_VARS = {
        "BANDIT_CONFIG_PATH": "/SimpleSecCheck/scanner/scanners/bandit/config/config.yaml"
    }
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("BANDIT_CONFIG_PATH", "/SimpleSecCheck/scanner/scanners/bandit/config/config.yaml")
