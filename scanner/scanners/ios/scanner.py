...
class iOSScanner(BaseScanner):
    ...
    ENV_VARS = {
        "IOS_CONFIG_PATH": "/SimpleSecCheck/scanner/scanners/ios/config/config.yaml"
    }
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("IOS_CONFIG_PATH", "/SimpleSecCheck/scanner/scanners/ios/config/config.yaml")
