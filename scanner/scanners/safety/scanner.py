...
class SafetyScanner(BaseScanner):
    ...
    ENV_VARS = {
        "SAFETY_CONFIG_PATH": "/SimpleSecCheck/scanner/scanners/safety/config/config.yaml"
    }
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("SAFETY_CONFIG_PATH", "/SimpleSecCheck/scanner/scanners/safety/config/config.yaml")
