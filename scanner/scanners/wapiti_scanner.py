...
class WapitiScanner(BaseScanner):
    ...
    def __init__(
        ...
        self.zap_target = zap_target or os.getenv("ZAP_TARGET", "http://host.docker.internal:8000")
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("WAPITI_CONFIG_PATH", "/SimpleSecCheck/config/tools/wapiti/config.yaml")
    zap_target = os.getenv("ZAP_TARGET", "http://host.docker.internal:8000")
