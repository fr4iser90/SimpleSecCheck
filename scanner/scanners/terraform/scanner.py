...
class TerraformSecurityScanner(BaseScanner):
    ...
    ENV_VARS = {
        "TERRAFORM_SECURITY_CONFIG_PATH": "/SimpleSecCheck/scanner/scanners/terraform/config/config.yaml"
    }
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("TERRAFORM_SECURITY_CONFIG_PATH", "/SimpleSecCheck/scanner/scanners/terraform/config/config.yaml")
