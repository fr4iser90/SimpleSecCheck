...
class SemgrepScanner(BaseScanner):
    ...
    def __init__(
        ...
        self.rules_path = Path(rules_path) if rules_path else Path("/SimpleSecCheck/config/rules")
...
if __name__ == "__main__":
    ...
    rules_path = os.getenv("SEMGREP_RULES_PATH", "/SimpleSecCheck/config/rules")
