...
class AndroidScanner(BaseScanner):
    ...
    def __init__(
        ...
        """
        super().__init__("Android", target_path, results_dir, log_file, config_path)
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("ANDROID_CONFIG_PATH", "/SimpleSecCheck/config/tools/android/config.yaml")
