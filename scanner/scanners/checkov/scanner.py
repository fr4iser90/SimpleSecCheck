...
class CheckovScanner(BaseScanner):
    ...
    ENV_VARS = {
        "CHECKOV_CONFIG_PATH": "/SimpleSecCheck/scanner/scanners/checkov/config/config.yaml"
    }
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("CHECKOV_CONFIG_PATH", "/SimpleSecCheck/scanner/scanners/checkov/config/config.yaml")
