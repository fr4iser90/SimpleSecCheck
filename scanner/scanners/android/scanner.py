...
class AndroidScanner(BaseScanner):
    ...
    ENV_VARS = {
        "ANDROID_CONFIG_PATH": "/SimpleSecCheck/scanner/scanners/android/config/config.yaml"
    }
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("ANDROID_CONFIG_PATH", "/SimpleSecCheck/scanner/scanners/android/config/config.yaml")
