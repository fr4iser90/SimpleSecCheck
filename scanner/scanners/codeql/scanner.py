...
class CodeQLScanner(BaseScanner):
    ...
    ENV_VARS = {
        "CODEQL_CONFIG_PATH": "/SimpleSecCheck/scanner/scanners/codeql/config/config.yaml",
        "CODEQL_QUERIES_PATH": "/SimpleSecCheck/scanner/scanners/codeql/config/queries"
    }
    ...
    def __init__(
        ...
        self.queries_path = Path(queries_path) if queries_path else Path("/SimpleSecCheck/scanner/scanners/codeql/config/queries")
...
if __name__ == "__main__":
    ...
    config_path = os.getenv("CODEQL_CONFIG_PATH", "/SimpleSecCheck/scanner/scanners/codeql/config/config.yaml")
    queries_path = os.getenv("CODEQL_QUERIES_PATH", "/SimpleSecCheck/scanner/scanners/codeql/config/queries")
