...
@router.get(
    ...
    summary="Get scan findings (JSON)",
    description=(
...
async def get_scan_findings(
    ...
    limit: Optional[int] = Query(
        ...
        ge=1,
        le=200,
        description="Max findings per page (omit to return all)",
    ),
    offset: int = Query(0, ge=0, description="Skip this many findings after sort/filter"),
